      ...
      <div className="space-y-3">
        ...
        {!isLoading && clusters.length === 0 && (
          <div className="surface-card rounded-md border border-border p-8 text-center">
            ...
            <Link
              to="/clusters"
              className="mt-6 inline-flex items-center justify-center gap-2 rounded-full border border-black dark:border-white bg-transparent hover:bg-black dark:hover:bg-white text-foreground hover:text-white dark:hover:text-black px-4 py-2.5 text-sm font-semibold  shadow-sm transition-all"
            >
