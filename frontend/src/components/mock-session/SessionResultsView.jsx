...
import { CheckCircle, XCircle, BarChart2, Home } from "lucide-react";

export default function SessionResultsView({ review, session }) {
                    ...
                    <div>
                      ...
                      {!correct && !skipped && (
                        <p className="text-xs text-red-500 font-semibold mt-1">
                          Your answer:{" "}
                          {rq.options[rq.selectedOptionIndexes[0]]}
                        </p>
                      )}
