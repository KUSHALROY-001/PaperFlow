...
export default function QuestionForm({
  ...
  const handleKeyDownTextarea = (e, field) => {
    ...
    if ((e.ctrlKey || e.metaKey) && e.key.toLowerCase() === "b") {
      ...
      const selectedText = e.target.value.slice(start, end) || "text";
      const next = `${e.target.value.slice(0, start)}${marker}${selectedText}${marker}${e.target.value.slice(end)}`;
                ...
                return (
                  ...
                  >
                    ...
                    <textarea
                      ...
                      value={opt}
                      onChange={(e) =>
                        !isViewer && updateOption(i, e.target.value)
                      }
