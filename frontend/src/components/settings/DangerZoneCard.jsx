  ...
  return (
    <div className="border border-red-500/30 rounded-2xl p-5 sm:p-6 bg-red-500/5">
      ...
      <p className="text-xs sm:text-sm text-muted-foreground mb-4">
        ...
        outputs permanently. You won't be able to do this if you own a workspace
        other people are still part of.
      </p>
      <button
        onClick={onOpenDeleteModal}
        className="flex items-center gap-2 px-5 py-2.5 bg-card border border-red-500/30 text-red-500 font-semibold rounded-full hover:bg-red-500/10 transition-all text-xs sm:text-sm"
      >
