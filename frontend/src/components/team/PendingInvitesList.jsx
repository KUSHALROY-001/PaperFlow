          ...
          >
            ...
            <div className="flex items-center gap-2 sm:gap-3 flex-wrap sm:flex-nowrap justify-between sm:justify-end shrink-0">
              ...
              <button
                ...
                className="text-xs font-semibold text-muted-foreground hover:text-foreground flex items-center gap-1 px-2.5 py-1.5 rounded-lg hover:bg-muted transition-colors border border-border sm:border-0"
              ...
              <button
                ...
                className="text-xs font-semibold text-red-500 hover:bg-red-500/10 px-2.5 py-1.5 rounded-lg transition-colors"
              >
                Revoke
              </button>
            </div>
