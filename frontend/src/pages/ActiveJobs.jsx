              ...
              >
                <div className="flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between mb-4">
                  ...
                  <Link
                    ...
                    className="flex w-full sm:w-auto items-center justify-center gap-1.5 text-xs sm:text-sm px-4 py-2 bg-black dark:bg-white text-white dark:text-black font-semibold hover:rounded-full rounded-md shadow-xs transition-all shrink-0"
                  >
